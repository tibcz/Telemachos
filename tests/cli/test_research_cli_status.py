"""`telemachos-research list --status complete` must match completed runs.
...
def _load_cli():
    path = ROOT / "scripts" / "telemachos-research"
    loader = importlib.machinery.SourceFileLoader("telemachos_research_cli_status", str(path))
