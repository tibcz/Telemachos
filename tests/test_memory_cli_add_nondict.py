"""cmd_add (scripts/telemachos-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "telemachos-memory"
    loader = importlib.machinery.SourceFileLoader("telemachos_memory_cli_add", str(path))
