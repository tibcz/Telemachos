...
_EXPECTED = [ "do_api_call", "do_app_api", "do_edit_image", "do_manage_calendar", "do_manage_contact",
    ...
    "_parse_tool_args", "_run_bw", "_skill_dump",
...
def test_every_facade_import_in_repo_resolves():
    ...
    _SKIP_DIRS = {
        ...
        "telemachos.egg-info", "static", "specs", "licenses", "docker",
    }
    names = set()
