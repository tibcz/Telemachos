...
```text
[order-report] working directory: /path/to/telemachos
...
[order-report] reproduce with: /path/to/telemachos/venv/bin/python /path/to/telemachos/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
