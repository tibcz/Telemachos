...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("telemachos-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/telemachos-foo`
...
VERSION = "0.1.0"  # bumped centrally; every telemachos-* CLI reports this
