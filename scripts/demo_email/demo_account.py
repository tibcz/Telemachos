#!/usr/bin/env python3
"""Create/remove the switchable 'Demo' EmailAccount in Telemachos.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@telemachos.local mailbox. Password is stored Fernet-encrypted
...
NAME = "Demo"
IMAP_USER = "demo@telemachos.local"
