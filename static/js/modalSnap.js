...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'telemachos-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'telemachos-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('telemachos:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
