...
// ── Key constants ──
export const KEYS = {
  THEME: 'telemachos-theme',
  TOGGLES: 'telemachos-toggles',
  ...
  MODELS_EXPANDED: 'telemachos-model-expanded',
  MODEL_ENDPOINTS: 'telemachos-model-endpoints',
  MODEL_SELECTED: 'telemachos-selected-model',
  SORT_ORDER: 'telemachos-sessions-sort',
  CHAT_SEARCH_SCOPE: 'telemachos-search-scope',
  INCOGNITO: 'telemachos-incognito',
  RAG_ACTIVE: 'telemachos-rag-active',
  MCP_ACTIVE: 'telemachos-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'telemachos-density',
  UI_SCALE: 'telemachos-ui-scale',
  WORKSPACE: 'telemachos-workspace'
};
