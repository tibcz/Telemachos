...
async def action_run_script(owner: str, script: str = "", host: str = "", **kwargs) -> Tuple[str, bool]:
    ...
    target_host = (host or os.getenv("TELEMACHOS_SCRIPT_HOST", "localhost")).strip()
                    ...
                    for uid_b in uids:
                        ...
                        try:
                            ...
                            if not raw:
                                ...
                                continue
                            msg = _email_mod.message_from_bytes(raw)
                            # Skip Telemachos-generated reminders so the scanner
                            ...
                            _ody_origin = (msg.get("X-Telemachos-Origin") or "").strip().lower()
                            _ody_kind = (msg.get("X-Telemachos-Kind") or "").strip().lower()
                            ...
                            if (_ody_origin == "telemachos-ui" or _ody_kind == "reminder"
