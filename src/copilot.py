...
COPILOT_USER_AGENT = os.environ.get(
    "TELEMACHOS_COPILOT_USER_AGENT", "Telemachos/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "TELEMACHOS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "TELEMACHOS_COPILOT_EDITOR_VERSION", "Telemachos/1.0"
)
